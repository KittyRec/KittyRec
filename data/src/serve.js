...
const tryText = "Example Usage: \'npm run serve 2018\'."
...
function run(ver, port) {
    ...
    switch(ver){
        ...
        case "2017": {
            ...
            console.log(`${chalk.yellow("[WARN]")} These servers active!`)
            require("../servers/2017/APIServer.js").start(port)
            require("../servers/2017/KittyRecMod.js")
            require("../servers/shared/WSServer.js").start()
            require("../servers/shared/CDN.js").start()
            require("../servers/shared/RPC.js")
            require("../servers/shared/RecNet.js")
            require("../servers/shared/mr-big-slappa.js")
            require("../servers/shared/mr-i-lev-up.js")
